...
import 'package:rentersparadise/src/views/screens/dashboard/favourites_page.dart';
import 'package:rentersparadise/src/views/screens/dashboard/home_page.dart';
import 'package:rentersparadise/src/views/screens/dashboard/search_page.dart';
import 'package:rentersparadise/src/views/screens/dashboard/settings_page.dart';
  ...
  Widget drawerContents(String itemName) {
    return ListTile(
      ...
      subtitle: Text(
        itemName,
        style: TextStyle(
            color: Colors.white, fontSize: 18.0, fontFamily: 'Futura'),
      ),
      onTap: () {},
    );
  }
