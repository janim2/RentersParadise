...
class CustomPropertyOwnerCard extends StatefulWidget {
  @override
  _CustomPropertyOwnerCardState createState() => _CustomPropertyOwnerCardState();
  ...
  * @param imageCarFill -  image representing car parks*/
  CustomPropertyOwnerCard({Key key, @required this.imageNathan, @required this.imageBed, @required this.imageBath, @required this.imageCarFill});
}

class _CustomPropertyOwnerCardState extends State<CustomPropertyOwnerCard> {
